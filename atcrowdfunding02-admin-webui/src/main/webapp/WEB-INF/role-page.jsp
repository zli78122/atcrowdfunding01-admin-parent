...
<script type="text/javascript">
	$(function(){
		...
		$("#rolePageBody").on("click", ".updateBtn", function(){
			...
			// 获取当前角色的id
			// 依据是：var updateBtn = "<button id='" + roleId + "' ...></button>
			// 为了更新时能够获取roleId的值，把它放在全局变量上
		...
		$("#assignBtn").click(function(){
			...
			var requestBody = {
				...
				// 为了服务器端的handler方法能够统一使用List<Integer>方式接收数据，roleId也存入数组
